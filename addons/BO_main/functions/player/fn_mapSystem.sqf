...
// Wire the Draw EH onto the GPS once, then self-remove the PFH so we
// don't thrash the EH every 0.5s for the whole session. Mirrors the
// OT_OnDraw one-shot pattern at line 99 in this file.
[
    {
        params ["", "_id"];
