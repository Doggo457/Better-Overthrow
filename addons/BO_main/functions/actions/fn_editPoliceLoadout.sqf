...
private _soldier = ["Police", getPlayerUID player] call OT_fnc_getSoldier;
...
[
    "ace_arsenal_displayClosed",
    {
        ...
        // BO: per-player storage instead of clobbering the global
        // OT_Loadout_Police and broadcasting it to every client.
        ["Police", _loadout] call BO_fnc_savePlayerLoadout;
