...
OT_NATO_Unit_AT = "B_W_soldier_LAT_F";
OT_NATO_Unit_AT_Heavy = "B_W_Soldier_AT_F";
OT_NATO_Unit_SF = "B_W_Soldier_F";
...
// BO: civil police respond in police cars, not MRAPs/gunships.
OT_NATO_Vehicles_PoliceSupport = [OT_NATO_Vehicle_Police];
...
OT_factory = "Land_dp_smallFactory_F";
