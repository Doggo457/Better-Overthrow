...
[
    ...
    },
    {
        ...
        // Clear the per-town paid flag so it doesn't accumulate on server_nosave across the campaign
        server_nosave setVariable [_destinationName + "transformerpaid", nil, true];
    },
    _params
];
